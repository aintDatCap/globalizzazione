...
<article>
	...
	<p class="description">
		...
		1869, dimezzò la durata del viaggio da Londra a Bombay; ma soprattutto l’inaugurazione del
		servizio telegrafico transatlantico, tra Londra e New York (1866), Melbourne (1872) e Buenos
		Aires (1874), permise alle comunicazioni transcontinentali di passare dalle settimane ai minuti.
