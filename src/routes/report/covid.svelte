...
<article>
	...
	<p class="description">
		...
		Quindi si può riassumere in “work anytime, anywhere”. Nel 2020, per effetto dell’impulso dato
		dal governo al ricorso del lavoro agile, a seguito dell’emergenza sanitaria, si è registrato una
